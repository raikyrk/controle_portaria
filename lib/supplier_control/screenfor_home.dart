// lib/supplier_control/screenfor_home.dart
import 'package:flutter/material.dart';
import 'package:flutter_feather_icons/flutter_feather_icons.dart';
import 'time_date.dart';
import 'entry_form.dart';
import 'exit_form.dart';

class ScreenforHome extends StatefulWidget {
  const ScreenforHome({super.key});

  @override
  State<ScreenforHome> createState() => _ScreenforHomeState();
}

class _ScreenforHomeState extends State<ScreenforHome>
                    ...
                    Expanded(
                      child: Column(
                        children: [
                          ...
                          const Text(
                            'Sistema de Registro na Portaria',
                            style: TextStyle(
                              fontSize: 18,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: const [
                      ...
                      SizedBox(width: 10),
                      Text(
                        'Sistema Seguro de Controle de Fornecedores v1.0',
                        style: TextStyle(
                          fontSize: 14,
                          color: Color(0xFF6B7280),
